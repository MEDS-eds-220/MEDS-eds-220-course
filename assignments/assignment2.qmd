...
- File formatting and uploading:
  ...
  - [ ] Before you upload your finished notebooks to Gradescope, please rename your notebooks so they are called `hwk2-task1-salmon-YOURLASTNAME.ipynb` and  `hwk2-task3-aqi-YOURLASTNAME.ipynb`.
