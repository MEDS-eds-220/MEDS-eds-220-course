...
- File formatting and uploading:
  ...
  - [ ] Before you upload your finished notebook to Gradescope, please rename your notebook so it is called
    - `hwk3-task2-oil-spills-YOURLASTNAME.ipynb`.
...
2. You may work locally using the `eds-220` environment or in the workbench-1 server using the `EDS-220` kernel.
