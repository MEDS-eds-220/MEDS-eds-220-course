...
:::{.callout-caution appearance="minimal"}
Sections 3, 4, and 5 must be completed in the `hwk4-task2-fire-scar-YOURLASTNAME.ipynb` notebook. In this notebook you will be using both your fire perimeter data and the simplified Landsat data `landsat8-2018-01-26-sb-simplified.nc`. You may need to complete data wrangling steps beyond the ones described to create the requested outputs.
:::
