...
- Task 1: add a blog post to your personal website based on one of your previous assignments and discussion sections. This task is 35% of the final grade.
- Task 2: create a presentation-ready GitHub repository featuring geospatial analysis in Python. This task is 65% of the final grade.
...
2. Create a map showing the Phoenix subdivision within its broader geographic context. You may use any vector or raster datasets to create your map. Be sure to include citations or descriptions for these datasets at the top of your notebook too. You can may also want to check out the `contextily` package to add a base map.
...
- To calculate the percentage area: (pixels with BII>=0.75)/(total pixels in Phoenix subdivision) * 100. 
:::
...
- The rest of your notebook should have:
    ...
    - [ ] Enough and appropriate markdown cells to explain the procedures you are using and their output. If your code comment is getting too long, you should probably move it to markdown cell as text.
