...
Import the `Colorado River Basin Water Conflict Table.csv` file [from the Science Base repository](https://www.sciencebase.gov/catalog/item/63acac09d34e92aad3ca1480) into your workspace. Name your data frame variable `df`.
...
Using `pandas` methods, obtain preliminary information and explore this dataset in at least four different ways.
...
## 7. Find 
a. Using method chaining and without creating new variables:
    ...
    ii. stack the results of the resulting data frame to obtain a `pandas.Series`
