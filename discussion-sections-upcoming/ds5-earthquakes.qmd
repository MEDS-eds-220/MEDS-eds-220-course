...
1. Create a new Github repository titled `Earthquake-branching `. Add a README,a python gitignore, and a MIT License.

2. Add your partner as a collaborater on your repository. In your Repo, navigate to **Settings**. Click on "Collaboraters", and add Partner #2 's github username as a collaborator. 
