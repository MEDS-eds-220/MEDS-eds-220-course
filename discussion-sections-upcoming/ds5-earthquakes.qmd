...
6. Complete the following exercise (#1, #2, and #3) together on Partner #1's computer. Don't worry, partner #2- since you are a collaborator, you have access to this repository like it is your own!
:::
...
You know have a branch called `main` that has the plot you and your partner created. You also have a branch called `partner1-branch` that has Partner #1's name as an author. We want to merge the changes from this `partner1-branch` into our main branch. To do so, we will create a pull request. 
