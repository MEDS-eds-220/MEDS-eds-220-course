...
c. Using the terminal, **clone the repository** into your `EDS-220` directory. To do this:
    ...
    3. Run `git clone URL`. The directory should appear in the folder navigation bar to the left.

    4. Navigate into the cloned repo in the terminal: `cd eds220-2024-sections`.
...
b. Push your changes to your **remote repository** (in this case, this is how we call the copy of your repo that lives in GitHub). 
