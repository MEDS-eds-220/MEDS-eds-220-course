...
a. Create a new repository on GitHub. Use the following settings:
    ...
    - Repository name: `eds220-2026-sections`.
...
c. Using the terminal, **clone the repository** into your `EDS-220` directory. To do this:
    ...
    ```default 
    cd eds220-2026-sections
    ```

    The `eds220-2026-sections` is your **local repository**, the copy of your repo that lives in your computer and from which you will send updates to GitHub. The **remote repository** is the copy of your repo that lives in GitHub.
...
a. Follow [this setup guide](/setup/setup-pat.qmd) to create and store a new PAT.
