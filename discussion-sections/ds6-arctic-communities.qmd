...
a. Download the data `arctic_communities.geojson` from [Google drive](https://drive.google.com/drive/folders/1USqhiMLyN8GE05B8WJmHabviJGnmAsLP?usp=share_link) and add it to your `data/` directory as appropriate. 

b. Read in the data into a variable named `df` and examine it with your team.
