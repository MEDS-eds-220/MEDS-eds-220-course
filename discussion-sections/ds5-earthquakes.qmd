...
### **Partner 2**
 ...
 2. Create a new branch to make edits on with the following command in the workbench terminal. This command is creating a new branch and calling it `partner2-branch` (be sure to update "partner2" with Partner #2's name!)
...
![](../discussion-sections/images/partner2_branch_output.png)
...
6.  Github will compare your branch with main and make sure there are no conflicts. If there are no conflicts, a "Merge pull request" option will appear. Click on this! 
...
2. Create a new branch to make edits on with the following command in the workbench terminal. This command is creating a new branch and calling it `partner1-branch` (be sure to update "partner1" with Partner #1's name!)
...
![](../discussion-sections/images/partner1_branch_output.png)
