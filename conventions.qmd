...
The IEEE citation style will be used. This is set up via the ieee-with-url.csl file and the `bibliography` and `csl` parameters in the _quarto.yml  file. 

References are added into one file for the whole course: references.bib.
...
## File naming
All files (except README) should be named in small caps and each word separated by -.
...
5. About the data in a `:::{.callout-note appearance="minimal"}} :::`
