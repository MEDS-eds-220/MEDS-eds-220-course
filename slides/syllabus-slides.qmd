...
![](images/fatiq.jpg){fig-align="center" width="35%"}
:::
...
[One-time, 2-day extension]{.slide-title}

<hr>

- Every student may use **one 2-day extension during the quarter, no questions asked**.
- To request it, you will need to send an e-mail to the TA by the homework due date. Only requests by the due date will be accepted.
...
GenAI tools (such as ChatGPT/Claude/Copilot) are **strongly discouraged** for the following reasons:
