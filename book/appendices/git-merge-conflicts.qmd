...
2) Resolve a git merge commit on a Quarto file.

3) Create and resolve merge conflicts on Quarto file with a partner. 

![Illustration from the [Openscapes](https://www.openscapes.org/) blog [GitHub for supporting, contributing, and failing safely](https://www.openscapes.org/blog/2022/05/27/github-illustrated-series/) by Allison Horst and Julia Lowndes.](images/git-merge-conflicts/horst-git.png)
...
1. **Team member 1:** Send team member 2 the link to your `merge_test_YOURLASTNAME`. GitHub repository.

2. **Team member 2:** Clone team member 1's repository to your local computer using VSCode. 
...
6. Discuss: what are some best practices you can follow with a team to avoide having merge conflicts?
