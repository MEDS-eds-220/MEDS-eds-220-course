...
```{python}
fp = os.path.join('data', 'aoi.geojson')
...
In our case, the AOI `geopandas.GeoDataFrame` does not have the same CRS as the rasters:
...
fig, ax = plt.subplots(figsize=(6, 6 * rgb.rio.aspect))  # Directly set size and aspect
