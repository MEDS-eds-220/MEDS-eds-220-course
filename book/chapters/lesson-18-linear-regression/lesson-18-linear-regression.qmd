...
- output data (the y-values or target data) shape should be `(n_samples,)`.
-  input data (the x-values or training data) shape should be `(n_samples, 1)`. The 1 comes because we have single feature modeling the output data.
