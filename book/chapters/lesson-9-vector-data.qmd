...
While shapefiles can be in any coordinate reference system, the [GeoJSON specification](https://datatracker.ietf.org/doc/html/rfc7946) requires GeoJSON files to use the World Geodetic System 1984 (WGS84) and all points must be expressed as longitude and latitude units of decimal degrees.
