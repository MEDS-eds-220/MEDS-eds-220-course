...
![Spatial extent of different vector data. Image adapted from: National Ecological Observatory Network (NEON)](/book/images/lesson-10/spatial-extent.png)
...
print('Initial number of observations: ' , len(pigs))
