...
**THIS WEEK ONLY: Annie will lead a setup session on Thursday and Carmen will lead class 1 on Friday.**

## What happened

### Setup session (Thursday)

1. Setup of discussion sections repository following [Repository setup instructions](/discussion-sections/ds0-sections-setup.qmd)
2. git merge conflict setup
