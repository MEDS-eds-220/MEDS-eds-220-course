...
::: {.callout-tip collapse="true" icon=false}
## VSCode set up
a. Create a `MEDS/EDS-220` directory in your personal computer.

b. Open VSCode.
  
c. Add a new **bash terminal** in it. 

d. Confirm git installation by running `git version` in the terminal. If git is installed you will get something similar to

```bash
git version 2.33.1
```

e. *If you don't get a similar output, install git by following the [MEDS installation guide](https://ucsb-meds.github.io/MEDS-installation-guide/#check-git).*
  
f. Clone your `eds-220-in-class` repository inside the `MEDS/EDS-220` directory. You can do this using the terminal or using the VSCode interface:
...
g. Confirm your conda installation by running `conda info` in the terminal. If conda is active you will get something similar to
...
h. *If conda needs to be added to the shell profile,  follow the [troubleshooting steps](https://ucsb-meds.github.io/MEDS-installation-guide/#install-Anaconda) in the MEDS installation guide within a **bash terminal** (not Powershell if you are on Windows).*
  
i. Install Python extension to VSCode:
...
## (1) Clone reposistory on VSCode
*All these steps take place in your local computer.*

1. Open VSCode on your computer.

2. In a terminal, verify that you have git installed.
...
3. Clone your `eds-220-in-class` repo through VSCode.
:::

::: {.callout-tip icon=false collapse="true" }
## 2. Python setup for VSCode
*All these steps take place in your local computer.*

1. Open VSCode on your computer.

2. In a terminal, verify that you have conda installed:
...
::: {.callout-tip icon=false collapse="true" }
## 3. Building the conda environment for the course in your computer
*Make sure you have completed the setup in 1, 2, and 3 before creating the environment.*

  1. Open VSCode on your computer.

  2. Download the following YAML file and move it to your `eds220-in-class` local directory:
    [https://github.com/MEDS-eds-220/MEDS-eds-220-course/blob/main/eds-220-env.yml](https://github.com/MEDS-eds-220/MEDS-eds-220-course/blob/main/eds-220-env.yml)
...
- Created a new one using this [YAML file](https://github.com/MEDS-eds-220/MEDS-eds-220-course/blob/main/eds-220-env.yml), name it `eds220-env` (that's why you should delete the old one).
