...
1. Coordinate reference systems [review](https://docs.google.com/presentation/d/1FrGVSyQ-DHH7NcV5geE-EYbQ59DaMK0uyPJuSsG2ZMk/edit?usp=sharing). 

2. Covered the [`geopandas`](https://meds-eds-220.github.io/MEDS-eds-220-course/book/chapters/lesson-10-geopandas-intro/lesson-10-geopandas-intro.html) notes.

<!-- ::: {.callout-tip icon=false collapse="true" }
## 🧭 Coordinate Reference Systems — Quiz

1. **Fill in the blank:**  
   A _____________ is a system used to represent locations on Earth as coordinates.  

2. **Multiple choice:**  
   The Earth is best modeled as:  
   a) A perfect sphere  
   b) A cube  
   c) An ellipsoid  
   d) A flat surface  
...
3. **Short answer:**  
   What do we call the process of aligning an ellipsoid so that its surface corresponds to real locations on Earth?  

4. **True or False:**  
   All datums are global — the same one can be used for any region without loss of accuracy.  

5. **Fill in the blank:**  
   A **geographic CRS** uses __________ and __________ to locate any point on Earth.  

6. **Multiple choice:**  
   The main purpose of a projection is to:  
   a) Make Earth’s 3D coordinates easier to read in degrees  
   b) Convert a 3D surface into a 2D map  
   c) Increase the precision of GPS signals  
   d) Remove all distortions from maps  

7. **True or False:**  
   Every projection preserves area, distance, and angles.  

8. **Short answer:**  
   What are the two coordinate names commonly used in a projected CRS?  

9. **Fill in the blank:**  
   A projected CRS expresses coordinates in linear units such as __________.  

10. **Short answer:**  
    Name one key difference between a **geographic CRS** and a **projected CRS**.
::: -->
