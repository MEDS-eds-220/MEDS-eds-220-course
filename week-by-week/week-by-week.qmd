...
We started from a pre-filled notebook that students downloaded before class.

::: {.callout-warning icon=false}
## Preparation for next class
Download the notebook [`week8-xarray-STUDENTS.ipynb`](https://drive.google.com/drive/folders/1L1bvxICUy1OkW5_UNMA_WTjOCXUaE8Nz?usp=sharing), rename it to `week8-clipping.ipynb`, and move it into your `EDS-220/eds220-in-class` directory. 
