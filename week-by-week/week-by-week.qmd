...
1. Students solved an exercise baed on the [updating dataframes](/book/chapters/lesson-5-updating-dataframes.qmd) notes column wrangling. 
...
1. Install VS Code on your local computer and make sure Python is running. 
Materials: https://ucsb-meds.github.io/MEDS-installation-guide/#install-vscode
...
- Check-in with your discussion section teams via Slack to make sure you’re all ready!
:::
-->
...
1. Covered [conda environments notes](/book/appendices/A-python-environments.qmd).
2. Built [conda environment](/book/appendices/A-python-environments.qmd) for the course.
