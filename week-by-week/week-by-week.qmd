...
::: {.callout-warning icon=false}
## Preparation for Wednesday class (November 4=6)
Finish reading [functions notes](/book/chapters/lesson-11-csv-to-geodataframe/) and prepare exercie at the end of section.
:::

### Class 12

- Students present exercise from [functions notes](/book/chapters/lesson-11-csv-to-geodataframe/).
- Covered the [reprojecting notes](/book/chapters/lesson-12-merge-data/). 