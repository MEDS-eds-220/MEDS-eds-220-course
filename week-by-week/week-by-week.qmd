...
## Building conda environment for the course
*Make sure you have completed the VSCode set-up before creating the environment.*

  1. Open VSCode on your computer.

  2. Download the following YAML file and move it into your `eds220-in-class`  directory:
    [https://github.com/MEDS-eds-220/MEDS-eds-220-course/blob/main/eds-220-env.yml](https://github.com/MEDS-eds-220/MEDS-eds-220-course/blob/main/eds220-env.yml)
