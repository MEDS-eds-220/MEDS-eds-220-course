...
3. (maybe) Built [conda environment](/book/appendices/A-python-environments.qmd) for the course.

::: {.callout-tip icon=false collapse="true" }
## Building the conda environment for the course in your computer
  1. Open VSCode on your computer.

  2. Clone your `eds220-in-class` GitHub repository. You can do it using the command palette. 

  3. Download the following YAML file and move it to the top of your `eds220-in-class` local directory:
